...
class ARcm_seg(object):
    ...
    def get_mask(self, Cframe, Cbbox, prev_msk, dtm=None, vis=False, trt='false'):
        """
        ...
        '''
        img_adv = utls.TrackPGD(self.refine_network, Cpatch, Cbbox, prev_msk, dtm, trt, self.search_factor)
        ...
        Pmask_arr = mask_torch2numpy(pred.detach())
